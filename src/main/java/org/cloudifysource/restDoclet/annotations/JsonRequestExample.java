...
/**
 * 
 * <P>Annotation to specify an example of a JSON request.<br />
 ...
 * 
 * <p>For example:
 * <dd><code>JsonRequestExample(requestBody = "{parameterName = parameterValue}", comments = "some comments")</code></p>
 * 
 * @author yael
 *
 */
